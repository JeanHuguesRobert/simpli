...
// Client side setup, dynamic, different for each page
  ...
  return [
    ...
    // ToDo: should be moved at the very beginning of <head>
...
// once the page is "ready"
  ...
  $(document).ready( function(){
    ...
    // Install "Click to edit"
    if( window.sw_grow ){ window.sw_grow( "init") }
    ...
    de&&bugC( "ready in: " + ((new Date()).getTime() - sw_time_loaded) + "ms")
  })
