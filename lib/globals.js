...
var SW = {
  ...
  wd:       "",     // Work directory, defaults to current work directory
  static_dir: "",   // Static files directory, idem
  dir:      "",		  // Local to SW.wd, where wiki page files are, must exist
...
// If file config.json exists, it's content is included, ToDo
{
  ...
  veryOpen:       false,// If false, members need a curator stamp
  ...
  curatorUser:     "",	// default curator
  curatorCode:     "",	// hard coded default curator's login code
  curators:        "",	// Users that become curator when they log in
  adminIps:       "",	// Curators from these addresses are admins
