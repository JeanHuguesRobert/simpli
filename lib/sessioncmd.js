...
// ToDo: Use "switch" ! ;-) 
  ...
  if( cmd == "Drafts" || cmd == "DraftsAndCodes" ){
    ...
    // non curators see codes obscured, they can monitor if curators manage them
    var buf        = []
    var bufcodes   = []
    var bufusers   = []
    var with_codes = (that.canCurator && cmd == "DraftsAndCodes" || that.isCurator)
