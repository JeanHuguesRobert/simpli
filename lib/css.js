...
Sw.padding = 'padding: 0'; // 0px 1em 0px 1em;'
Sw.font
...
SW.dark_red = "B01"; // was darker "942" before 2014
Sw.style = [
'',
...
'body {',
  ...
  '-moz-tap-highlight-color: #c00;',
	'tap-highlight-color: #c00;',
...
'#header {',
  ...
  'padding-left: 1em;', // Space form hamberger menu sign of the left
...
'ul {',
  ...
  Sw.monofont, // 2014, was Sw.font before
'}',
...
// Style for Kudocracy vote buttons
'.kudocracy-button iframe {',
