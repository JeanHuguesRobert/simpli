...
// parent wiki before being logged in the child wiki.
  ...
  if( !relog ){
    ...
    if( query && query.kudocracy ){
      ...
      if( kudo_name ){
        this.setLoginName( "@" + query.kudocracy );
      }
    }
    ...
    if( query && query.kudocracy ){
      this.loginName = "@" + query.kudocracy;
      this.isAuthentic = true;
      this.twitterName = query.kudocracy.toLowerCase();
      this.twitterLabel = query.kudocracy;
      this.twitterId = query.kudocracy.toLowerCase();
    }
  }
