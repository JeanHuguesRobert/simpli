...
function bugScript(){
// Client side version
// Like console.log() but inject x.toString() when argument has a .toString()
...
function debug_mode( flag ){
// Very global method to enable/disable debug mode.
